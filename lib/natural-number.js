...
var parse_numbers = require("./parsenum");
var parse_dates = require("./parsedates");
var parse_quantity = require("./parsequantities");
...
natNumber.prototype = {
  ...
  parse_dates: function(string, parsed, callback) {
    var p = parse_dates.parsedates(string);
...
//    console.log("h")
  ...
  parse_numbers: function(string, parsed, callback) {
    var p = parse_numbers.parsenum(string);
  ...
  splitWords: function(string, stopwords) {
    ...
    splitWords.split_words(string,stopwords)
